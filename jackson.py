...
def generar_boleta():
     ...
     for boleta in generar_boleta:
        
      print("  ------------------------------------------------------------- ")
      print("\n--- Detalles de la boleta ---")
      print(f"Fecha y hora: {boleta['fecha_hora']}")
      print(f"Cliente: {boleta['nombre_cliente']}")
      print(f"Tipo de cliente: {boleta['tipo_cliente']}")
      print(f"Tipo de pizza: {boleta['tipo_pizza']}")
      print(f"Tamaño de pizza: {boleta['tamaño_pizza']}")
      print(f"Cantidad: {boleta['cantidad']}")
      print(f"Precio unitario: {boleta['precio_unitario']}")
      print(f"Precio total: {boleta['precio_total']}")
      print(f"Descuento aplicado: {boleta['descuento'] * 100}%")
      print(f"Precio final: {boleta['precio_final']}")
      print("  ------------------------------------------------------------- ")
def anular_venta():
